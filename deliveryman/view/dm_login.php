...
<table>
    ...
    <td><h3><input type="text" name="dmuname" placeholder="Enter username"></h3></td>
    <td> <?php
            echo $usernameError;
       ?>
       </td></tr>
       <tr><td><b><h3>Password : </h3></td>
       <td><h3><input type="password"name="dmpassword"></h3></td>
       <td> <?php
            echo $userPass_Error;
       ?>
       </td></tr>
...
<input type="submit" name="dmsubmit" value="Login">
<input type="Reset" name="Reset" value="Reset"><br>
<p><h3><a href="dm_registration.php"><p>No Account? Register now!</h3></p></a>
</form>
